...
class UserHandler:
    ...
    """
    @staticmethod
    def add(uid: str, name: str, masterpass: str) -> bool:
        """Add a new user account

        Args:
            uid(str): user discord id
    ...
    @staticmethod
    def update(uid: str, name: str, masterpass: str) -> bool:
...
class EntryHandler:
    ...
    """
    @staticmethod
    def add(uid: str, url: str, username: str, password: str) -> bool:
        """Add a new entry
    ...
    @staticmethod
    def update(uid: str, url: str, username: str, password: str) -> bool:
        """Update an entry
    ...
    @staticmethod
    def delete(uid: str, url: str) -> bool:
        """Delete an entry
